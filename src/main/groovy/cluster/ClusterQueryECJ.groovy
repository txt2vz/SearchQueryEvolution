...
public class ClusterQueryECJ extends Problem implements SimpleProblemForm {
    ...
    public void evaluate(final EvolutionState state, final Individual ind, final int subpopulation,
        ...
        final int   k =  (ClusterMainECJn2.SETK) ? genomeOrig[0] :  Indexes.index.numberOfCategories

        final int[] genome = (ClusterMainECJn2.SETK) ? genomeOrig[1.. genomeOrig.size()-1] as int[] : genomeOrig
       ...
       // final int uniqueHits = uniqueHitsTuple.v2
        ...
        final double f = (ClusterMainECJn2.SETK) ? uniqueHits * (1.0 - (0.04 * k)) as double : uniqueHits as double
